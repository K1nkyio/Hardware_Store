...
import { createProductReview, ProductReview } from "@/lib/api";
...
const ReviewProduct = ({ productId, onReviewAdded }: ReviewProductProps) => {
      ...
      <DialogContent className="sm:max-w-md !rounded-none">
        <DialogHeader>
          ...
          <DialogDescription className="font-light text-sm text-muted-foreground">
            Rate this product and share your feedback.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-6">
          <div className="space-y-3">
            <label className="text-sm font-light text-foreground">Your name</label>
            <Input
              value={authorName}
          ...
          <div className="space-y-3">
            <label className="text-sm font-light text-foreground">Review title</label>
            <Input
              value={title}
