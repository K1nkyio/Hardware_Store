export const en = {
  ...
  checkout: {
    ...
    mpesaInstructions: "You'll receive a prompt on your phone to complete payment",
    ...
    emptyCartMessage: "No items in your cart",
    continueShopping: "Continue Shopping",
    backToCart: "Back to Cart",
    securePayment: "Secure Payment",
    securePaymentMessage: "Your payment information is secure and encrypted",
  },
  common: {
    ...
    results: "results",
    allCategories: "All Categories",
    noMatchFilters: "No project guides match your current filters",
